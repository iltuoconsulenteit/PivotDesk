...
The “Developed by” logo in the header scales down responsively as viewport width decreases, matching the adaptive behavior of the main app logo.
...
Wiki open action is available as a visible top-bar help button (**❓ Aiuto**); markdown images are rendered in-panel including docs/static assets.
