...
from services.adapters.gsheet_account_adapter import GoogleAccountSheetAdapter
...
def build_source_adapter(source: dict[str, Any], connections: dict[str, Any] | None = None):
    ...
    if source_type in {"gsheet_account", "google_sheet_account", "google_account_sheet"}:
        return GoogleAccountSheetAdapter(source, connections)
